 ...
 * El resultado de la tarea es de tipo Double. Usaremos Integer para actualizar la barra de progreso.
 * 
 * @author Chuidiang
 * 
 */
public class Worker2 extends SwingWorker<Double, Integer> {
	...
	/**
	 * Le pasamos la etiqueta que tiene que poner "Hecho" cuando termine la tarea y el barra de progreso que queremos que se vaya a actualizar.
	 * 
	 * @param unaEtiqueta
	...
	/**
	 * Tarea terminada, SwingWorker llama a este metodo en el hilo de despacho de eventos. Aqui actualizamos la etiqueta para que ponga "Hecho".
	 */
	@Override
	protected void done() {
	...
	/**
	 * SwingWorker llama a este metodo en el hilo de despacho de eventos cuando llamamos a publish() y le pasa los mismos parametros que nosotros pongamos en publish().<br>
