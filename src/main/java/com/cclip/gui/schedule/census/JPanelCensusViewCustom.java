...
public class JPanelCensusViewCustom extends JPanelCensusView {
	...
	public void setScheduleCensusId(String scheduleCensusId) {
		this.setScheduleCensus(Services.getInstance().findScheduleCensusById(scheduleCensusId));
	}
	...
	public void setScheduleCensus(ScheduleCensus scheduleCensus) {
		...
		jPanelView.setVisible(true);
		print();
		this.jPanelCadastreView.setCadastreCensusId(this.scheduleCensus.getCadastreCensus().getId());
	}
	...
	private void print() {
		...
		if (scheduleCensus.getInsertCadastre() != null && scheduleCensus.getInsertCadastre() == true) {
			jLabelType.setText("I");
		} else if (scheduleCensus.getDeleteCadastre() != null && scheduleCensus.getDeleteCadastre() == true) {
			jLabelType.setText("D");
		} else if (scheduleCensus.getUpdateCadastre() != null && scheduleCensus.getUpdateCadastre() == true) {
		...
		if (scheduleCensus.getCensused() != null) {
			jLabelCensused.setText(new SimpleDateFormat("dd/MM/yyyy").format(scheduleCensus.getCensused()));
		} else {
			jLabelCensused.setText("");
		}

		if (scheduleCensus.getNumberCensus() != null) {
			jLabelNumberCensus.setText(scheduleCensus.getNumberCensus().toString());
		} else {
		...
		if (scheduleCensus.getScheduleCensusResult() != null) {
			jLabelResult.setText(scheduleCensus.getScheduleCensusResult().toString());
		} else {
			jLabelResult.setText("");
		}

		if (scheduleCensus.getScheduleBatch() != null) {
			jLabelScheduleBatch.setText(scheduleCensus.getScheduleBatch().toString());
		} else {
			jLabelScheduleBatch.setText("");
		}

		if (scheduleCensus.getCensusTaker() != null) {
			jLabelCensusTaker.setText(scheduleCensus.getCensusTaker().toString());
		} else {
		...
		if (scheduleCensus.getSignatureCensused() != null && scheduleCensus.getSignatureCensused() == true) {
			jLabelSigned.setText("Si");
		} else if (scheduleCensus.getSignatureCensused() != null && scheduleCensus.getSignatureCensused() == false) {
		...
		if (scheduleCensus.getM2GeneralBuilding() != null) {
			jLabelM2GeneralBuilding.setText(scheduleCensus.getM2GeneralBuilding().toString());
		} else {
			jLabelM2GeneralBuilding.setText("   ");
		}
		
		if (scheduleCensus.getM2BuildingsPublicEntertainment() != null) {
			jLabelM2BuildingsPublicEntertainment.setText(scheduleCensus.getM2BuildingsPublicEntertainment().toString());
		} else {
			jLabelM2BuildingsPublicEntertainment.setText("   ");
		}
		
		if (scheduleCensus.getM2ProgressConstruction() != null) {
			jLabelM2ProgressConstruction.setText(scheduleCensus.getM2ProgressConstruction().toString());
		} else {
			jLabelM2ProgressConstruction.setText("   ");
		}
		
		if (scheduleCensus.getM2ShedsGeneral() != null) {
			jLabelM2ShedsGeneral.setText(scheduleCensus.getM2ShedsGeneral().toString());
		} else {
